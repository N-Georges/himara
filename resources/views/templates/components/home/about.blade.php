            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="info-branding">
                        ...
                        <div class="providers">
                            ...
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('himara/images/providers/provider-1.png') }}" alt="Image">
                                </a>
                            </div>
                            <!-- ITEM -->
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('himara/images/providers/provider-2.png') }}" alt="Image">
                                </a>
                            </div>
                            <!-- ITEM -->
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('himara/images/providers/provider-3.png') }}" alt="Image">
                                </a>
                            </div>
                            <!-- ITEM -->
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('himara/images/providers/provider-4.png') }}" alt="Image">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="brand-info">
                        <div class="inner">
                            <div class="content">
                                <img src="{{ asset('himara/images/logo-big-transparent.svg') }}" width="100" alt="Image">
                                <div class="stars">
