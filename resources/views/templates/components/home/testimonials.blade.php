        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonials-owl">
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div class="author-img">
                            <img alt="Image" class="img-fluid" src="{{ asset('himara/images/users/user1.jpg') }}">
                        </div>
                        <div class="author">
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div class="author-img">
                            <img alt="Image" class="img-fluid" src="{{ asset('himara/images/users/user2.jpg') }}">
                        </div>
                        <div class="author">
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div class="author-img">
                            <img alt="Image" class="img-fluid" src="{{ asset('himara/images/users/user3.jpg') }}">
                        </div>
                        <div class="author">
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div class="author-img">
                            <img alt="Image" class="img-fluid" src="{{ asset('himara/images/users/user4.jpg') }}">
                        </div>
                        <div class="author">
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div class="author-img">
                            <img alt="Image" class="img-fluid" src="{{ asset('himara/images/users/user5.jpg') }}">
                        </div>
                        <div class="author">
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div class="author-img">
                            <img alt="Image" class="img-fluid" src="{{ asset('himara/images/users/user6.jpg') }}">
                        </div>
                        <div class="author">
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div class="author-img">
                            <img alt="Image" class="img-fluid" src="{{ asset('himara/images/users/user7.jpg') }}">
                        </div>
                        <div class="author">
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div class="author-img">
                            <img alt="Image" class="img-fluid" src="{{ asset('himara/images/users/user8.jpg') }}">
                        </div>
                        <div class="author">
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div class="author-img">
                            <img alt="Image" class="img-fluid" src="{{ asset('himara/images/users/user9.jpg') }}">
                        </div>
                        <div class="author">
