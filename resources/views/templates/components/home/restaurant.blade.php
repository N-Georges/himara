   <!-- ========== RESTAURANT ========== -->
   <section class="restaurant image-bg parallax gradient-overlay op5" data-src="{{ asset('himara/images/restaurant.jpg') }}"
                   ...
                   <div class="restaurant-menu-item">
                       <div class="row">
                           <div class="col-lg-4 col-12">
                               <figure>
                                   <img src="{{ asset('himara/images/restaurant/restaurant1.jpg') }}" class="img-fluid " alt="Image">
                               </figure>
                           </div>
               ...
               <div class="col-md-6 col-sm-6 col-6">
                   <div class="restaurant-menu-item">
                       <div class="row">
                           <div class="col-lg-4 col-12">
                               <figure>
                                   <img src="{{ asset('himara/images/restaurant/restaurant2.jpg') }}" class="img-fluid" alt="Image">
                               </figure>
                           </div>
                           <div class="col-lg-8 col-12">
                               <div class="info">
