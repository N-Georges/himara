                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="room-price">
                                        ...
                                        <a href="{{ route('room.show', $item->id) }}" class="btn btn-sm">view <br> details</a>
                                    </div>
                                </div>
                            </div>
                        @empty
