                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input value="{{ $room->image }}" name="image"
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input value="{{ $room->city }}" type="text" name="city" id="city"
                                        autocomplete="city"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="price" class="block text-sm font-medium text-gray-700">Price</label>
                                    <input value="{{ $room->price }}" type="text" name="price" id="price"
                                        autocomplete="price"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select id="categorie_id" name="categorie_id" autocomplete="categorie_id"
                                        ...
                                        @foreach ($categorie as $item)
                                            <option {{ $item->id == $room->categorie->id ? 'selected' : '' }}
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <textarea value="{{ $room->description }}" name="description"
                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                        id="exampleFormControlTextarea1" rows="3">{{ $room->description }}</textarea>
                                </div>
                            </div>
                        </div>
