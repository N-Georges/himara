            ...
            <div class="flex items-center justify-between">
                <div class="lg:ml-40 ml-10 space-x-8 flex">
                    <a href="{{ route('blog.index') }}"
                        ...
                        blog</a>
                    <a href="{{ route('blogCat.create') }}"
                        class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">create categorie</a>
        ...
        <div>
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <span
                                            ...
                                            <span class="relative font-bold">{{ $item->categorie->name }}</span>
                                        </span>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">
                                            {{ Str::of($item->description)->words(10) }}</p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex">
                                            <a href="{{ route('blog.edit', $item->id) }}" class="mr-5"><svg
                                            ...
                                            <button @click="show=true" href="" class="text-red-600"><svg
                                                    class="w-6 h-6" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                    ...
                    @include('components.delete-blog-modal')
